...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.WALLS)
                .add(ModBlocks.POLISHED_ORIGIN_ALLOY_WALL.get())
                .add(ModBlocks.ORIGIN_ALLOY_BRICK_WALL.get())
                .add(ModBlocks.POLISHED_MEGA_SHARD_WALL.get())
                .add(ModBlocks.MEGA_SHARD_BRICK_WALL.get());

        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(ModBlocks.ORIGIN_ALLOY_BLOCK.get())
                .add(ModBlocks.MEGA_SHARD_BLOCK.get())
                .add(ModBlocks.POLISHED_ORIGIN_ALLOY.get())
                .add(ModBlocks.ORIGIN_ALLOY_BRICKS.get())
                .add(ModBlocks.POLISHED_MEGA_SHARD.get())
                .add(ModBlocks.MEGA_SHARD_BRICKS.get())
                .add(ModBlocks.POLISHED_ORIGIN_ALLOY_STAIRS.get())
                .add(ModBlocks.ORIGIN_ALLOY_BRICK_STAIRS.get())
                .add(ModBlocks.POLISHED_MEGA_SHARD_STAIRS.get())
                .add(ModBlocks.MEGA_SHARD_BRICK_STAIRS.get())
                ...
                .add(ModBlocks.POLISHED_MEGA_SHARD_WALL.get())
                .add(ModBlocks.MEGA_SHARD_BRICK_WALL.get())
                .add(ModBlocks.CHISELED_ORIGIN_ALLOY.get())
                .add(ModBlocks.CHISELED_MEGA_SHARD.get());
